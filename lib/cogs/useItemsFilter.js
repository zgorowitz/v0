...
export function useItemsFilter(allItems = []) {
  ...
  }), [searchTerm, searchResults, selectedItems, selectedItemIds, appliedItemIds, addItem, removeItem, clearAll, selectAll, applyFilter, hasPendingChanges, filteredItems]);
}